"""
Django settings for triopo project.
...
SECRET_KEY = '_7i!af@nue-6b9)2$=x80fjbrxcjlsfk9-6mvp9al+%(=^e(cp'
...
WSGI_APPLICATION = 'triopo.wsgi.application'
